...
public class RubyOreBlock extends AllGemsItemsModElements.ModElement {
	@ObjectHolder("all_gems_items:ruby_ore")
	public static final Block block = null;
	public RubyOreBlock(AllGemsItemsModElements instance) {
		super(instance, 2);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(RubyGemItem.block, (int) (2)));
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}), block.getDefaultState(), 10)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(10, 1, 1, 100))));
		}
	}
}
