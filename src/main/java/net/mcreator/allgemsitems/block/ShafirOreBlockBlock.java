...
public class ShafirOreBlockBlock extends AllGemsItemsModElements.ModElement {
	@ObjectHolder("all_gems_items:shafir_ore_block")
	public static final Block block = null;
	public ShafirOreBlockBlock(AllGemsItemsModElements instance) {
		super(instance, 30);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("shafir_ore_block");
		}
